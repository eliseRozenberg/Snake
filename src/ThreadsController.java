...
public class ThreadsController extends Thread {
	ArrayList<ArrayList<SnakeColor>> Squares = new ArrayList<ArrayList<SnakeColor>>();
	Tuple headSnakePos;
	int sizeSnake = 3;
	long speed = 70;
	...
	ThreadsController(Tuple positionDepart) {
		...
		foodPosition = new Tuple(SnakeFrame.height - 1, SnakeFrame.width - 1);
